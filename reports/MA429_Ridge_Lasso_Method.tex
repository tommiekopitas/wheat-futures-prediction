...
The optimal Ridge configuration is $\alpha$ = 63.51, in the upper quarter of its search range, reflecting that strong regularisation is beneficial when the target is noisy and many features carry weak signal. Lasso's optimal $\alpha$=0.000146, very close to the lower bound of its range, resulting in a strikingly different results. This indicates that even very mild L1 shrinkage causes the model to deteriorate, the signal is not concentrated in a sparse feature subset and a dense solution is preferred, which is consistent with Ridge's strong regularisation requirement. Ridge achieves a validation directional accuracy of 49.93\% and R\textsuperscript{2} of −0.047. Lasso achieves a marginally better validation directional accuracy of 50.72\% and R\textsuperscript{2} of −0.042.
